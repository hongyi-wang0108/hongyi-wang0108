...
🇯🇵 Android Client Engineer based in **Tokyo** ／ 東京在住の Android クライアントエンジニア

大規模 Android アプリ開発、SDK 安定性改善、ログイン基盤刷新、ネットワーク通信コスト最適化、チーム横断の課題解決に取り組んできました。

- 📱 Large-scale Android app development
- 🔧 SDK stability improvement & troubleshooting flow design
- 📺 Login architecture refactoring for Android TV
- 🌐 Network performance & communication cost optimization
- 🤝 Cross-team collaboration (QA / Backend / CS / Product)
...
- **Data / DI**: Room, Coroutines, Hilt
- **Quality**: JUnit, logging & fallback design, CI/CD
...
### [永住トラッカー / Eijyo Tracker](https://github.com/hongyi-wang0108/eijyo_tracker)

日本で永住申請を行う外国人向けの Android アプリ。申請状況・予測タイムライン・書類チェックリスト・リスクセルフチェックを一つにまとめています。
...
<p>
  ...
  <img src="https://img.shields.io/badge/Hilt-2196F3?style=flat&logo=android&logoColor=white" />
  <img src="https://img.shields.io/badge/Room-FF6F00?style=flat&logo=sqlite&logoColor=white" />
  <img src="https://img.shields.io/badge/CI-GitHub%20Actions-2088FF?style=flat&logo=githubactions&logoColor=white" />
</p>

- 🧩 MVVM + ViewModel + StateFlow + Repository ／ Hilt DI ／ Room
- 📈 e-Stat 公開統計に基づく FIFO 待ち行列モデルの参考予測
- 🌏 日本語 / 中文 / English 対応、GitHub Actions による CI

📥 [APK ダウンロード](https://github.com/hongyi-wang0108/eijyo_tracker/releases) ・ 🎬 [デモ動画](https://www.youtube.com/shorts/TgmaKKPnQ48)
